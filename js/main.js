...
var swiper = new Swiper('.mySwiper', {
    ...
    spaceBetween: 30,
    slidesPerView: 'auto', // Set initial slidesPerView to 'auto' to allow dynamic adjustment
    breakpoints: {
...
// Update swiper settings on window resize
window.addEventListener('resize', function () {
    swiper.params.slidesPerView = 'auto'; // Reset slidesPerView to 'auto'
    swiper.update(); // Update Swiper instance
});

var clickableSwipper = ''; 
document.getElementById('marktingService').addEventListener('click',()=>{
    sessionStorage.setItem('services','services-type'); 
})